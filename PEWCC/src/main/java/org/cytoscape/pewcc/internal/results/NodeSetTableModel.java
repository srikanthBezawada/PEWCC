...
import org.cytoscape.pewcc.internal.logic.utils.UniqueIDGenerator;
import org.cytoscape.pewcc.internal.results.renderer.FruchtermanReingoldLayoutAlgorithm;
import org.cytoscape.pewcc.internal.results.renderer.GraphRenderer;
...
public class NodeSetTableModel extends AbstractTableModel {
    ...
    protected List<PEWCCCluster> nodeSets = new ArrayList<PEWCCCluster>();
    ...
    */
    public NodeSetTableModel(List<PEWCCCluster> nodeSets) {
    ...
    */
    public String[] getMemberNames(int row) {
            PEWCCCluster nodeSet = this.nodeSets.get(row);
            if (nodeSet == null)
                    return new String[0];
	 ...
	 */
	public PEWCCCluster getNodeSetByIndex(int row) {
	 ...
	 */
	public void remove(PEWCCCluster nodeSet) {
	...
	public void setProgressIcon(Icon value) {
        ...
        private void updateNodeSetDetails() {
            Executor threadPool = PEWCCapp.getThreadPool();
            int i = 0;

            nodeSetDetails.clear();
            nodeSetIcons.clear();
            for (PEWCCCluster nodeSet: nodeSets) {
        ...
        public Graph convertCyNetworkToGraph(CyNetwork network, String weightAttr) {
                org.cytoscape.pewcc.internal.results.Graph graph = new org.cytoscape.pewcc.internal.results.Graph(network);
